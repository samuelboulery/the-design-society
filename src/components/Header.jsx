    ...
    <section className="text-center pt-8 flex flex-col items-center justify-center text-primary source-sans relative">
      ...
      <div className="my-24 md:my-48 max-w-xl mx-auto px-4">
        ...
        <div className="flex justify-center space-x-6 py-4">
          <a href="https://thedesignsociety.eventbrite.com" target="_blank" rel="noopener noreferrer" className="text-2xl hover:text-black transition-colors">
          ...
          <a href="https://www.instagram.com/thedesignsociety_lyon/" target="_blank" className="text-2xl hover:text-black transition-colors">
          ...
          <a href="https://www.linkedin.com/company/the-design-society-lyon/" target="_blank" className="text-2xl hover:text-black transition-colors">
